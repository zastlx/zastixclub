...
export class AvatarService {
	...
	async getAvatar(userid: string): Promise<string> {
		// monkxy, xotic, me, pablo, allie, jod, syfe
		if (!["230580946557075457", "963728078520074250", "253302259696271360", "919417918566060053", "1021090674289942600", "944805064097276015", "190733468550823945"].includes(userid)) throw new BadRequestException();
